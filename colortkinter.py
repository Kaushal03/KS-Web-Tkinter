...
f2.pack(side=RIGHT)
########################################################################################################################
lblInfo=Label(Tops,font=("arial",30,"bold"),text="WELCOME TO THE COLOR GUESSING GAME ",fg="Steel Blue",bd=10,anchor="w")
lblInfo.pack()
...
def start():
    ...
    # add a score label 
    scoreLabel = Label(root, text = "Press enter to start", font = ('arial', 12,'bold')) 
    scoreLabel.pack() 

    # add a time left label 
    timeLabel = Label(root, text = "Time left: " +str(timeleft), font = ('arial', 12,'bold')) 
                                
    timeLabel.pack() 

    # add a label for displaying the colours 
    label = Label(root, font = ('arial', 60)) 
    label.pack() 

    # add a text entry box for 
    # typing in colours 
    e = Entry(root, font=('arial',40,'bold')) 
    ...
    # start the GUI 
    root.mainloop()
lblInfo=Label(rt,font=("arial",23,"bold"),text=" ",fg="Steel Blue",bd=10,anchor="w")
lblInfo.pack()
