...
f2.pack(side=RIGHT)
########################################################################################################################
lblInfo=Label(Tops,font=("arial",30,"bold"),text="WELCOME TO THE GAME TIC TAC TOE",fg="Steel Blue",bd=10,anchor="w")
lblInfo.pack()
...
def start():
    ...
    label1=Label(root,text="Player1 : X",font=("arial",15,"bold"),fg="Steel Blue",bd=10,anchor="w")
    label1.grid(row=0,column=1)


    l2=Label(root,text="Player2 : O",font=("arial",15,"bold"),fg="Steel Blue",bd=10,anchor="w")
